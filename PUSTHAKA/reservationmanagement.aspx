<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="reservationmanagement.aspx.cs" Inherits="PUSTHAKA.reservationmanagement" %>
					...
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="row">
									...
									<asp:Button ID="Button2" class="btn btn-lg btn-block btn-primary" runat="server" Text="Sell" OnClick="Button2_Click" />
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="row">
											<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:PusthakaDBConnectionString %>' SelectCommand="SELECT * FROM [reservations_table]">
											</asp:SqlDataSource>
											<div class="col">
												<asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnRowDataBound="GridView1_RowDataBound">
													<Columns>
														...
														<asp:BoundField DataField="reserveDate" HeaderText="Reserve Date" SortExpression="reserveDate"></asp:BoundField>
